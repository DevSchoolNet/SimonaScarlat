...
namespace multiauth
{
	...
	public class AuthenticationHandler
	{
		...
		public bool TryAll(string userName, string password)
		{
            ...
            ICanAuthenticateUsers windowsUser = new WindowsAuthenticationModule.WindowsAuthentication();
            ICanAuthenticateUsers formsUser = new FormsAuthenticationModule.FormsAuthentication();
            ICanAuthenticateUsers googlUser = new GoogleAuthenticationModule.GoogleAuthentication();

            windowsUser.NextModule = formsUser;
            formsUser.NextModule = googlUser;

             login = windowsUser.LogIn(userName, password);
